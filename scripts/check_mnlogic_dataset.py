#!/usr/bin/env python3
"""Validate a prepared MNLogic dataset and print a short summary."""
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        ...
        default=None,
        help=(
            "Prepared dataset root. If omitted, use the default MNLogic root "
            "from src/configs/datasets/mnlogic.yaml."
        ),
    )
...
def main() -> int:
    ...
    try:
        adapter = create_dataset_adapter("mnlogic", dataset_root=dataset_root)
